...
- In this environment, invoke skills via `/flowbit:<skill>` (for example: `/flowbit:spec-init`, `/flowbit:development`).
...
- If standards are missing, continue work but recommend initializing Flowbit docs with `/flowbit:spec-init`.
