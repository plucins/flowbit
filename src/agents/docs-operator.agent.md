...
**You are not user-facing.** You are invoked by parent skills (bootstrap, standards-update, standards-discover) via the Task tool so they can continue executing after you complete.
