...
**IMPORTANT**: Do NOT write any files to disk. The flowbit-spec-init command will use your returned analysis to generate proper documentation in `.flowbit/docs/`.
